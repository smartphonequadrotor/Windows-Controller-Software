...
{
    public partial class flightOrientation : UserControl
    {
        ...
        {
            flightOrientationBox.Image = null;
            flightOrientationBox.Refresh();
            flightOrientationBox.BackColor = Color.LightBlue;
            int wid = flightOrientationBox.Width;
            int hgt = flightOrientationBox.Height;
